...
- Avoid running build scripts unless asked; they delete build artifacts and
  pin submodule tags.
...
- Build succeeds via `./build.sh <board> <build_type> <uuid>`.
- `dist/` contains the UF2/JSON/md5sum artifacts.
